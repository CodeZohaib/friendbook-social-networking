...
if(is_array($data))
{
    $totalPostReport=$data[4]['totalPostReport'];
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Admin Panel | Reported Post</title>
      ...
      <?php require_once __DIR__.'/include/header.php'; ?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1><i class="fa fa-newspaper-o"></i> Post Report <small>View All Post Reports</small></h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo BASEURL; ?>/admin/"><i class="fa fa-tachometer"></i> Dashboard</a></li>
                      <li class="active"><i class="fa fa-users"></i> <a href="<?php echo BASEURL; ?>/admin/allPostReport">Post Reported</a></li>
                    </ol>
                   ...
                   <form method="POST" action="<?php echo BASEURL; ?>/admin/searchUser" class="search_friend_profile">
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          ...
                          <input type="hidden" class="form-control" name="reportedPost" hidden="true">
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="searchUserData">
                        <?php
                         Pagination_admin($totalPostReport,'getAllPostReport'); 
                        ?>
                    </div>
                </div>
            </div>
